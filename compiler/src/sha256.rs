//! Small dependency-free SHA-256 used for proof-evidence identities.
//!
//! This is deliberately shared by production cache validation and the proof-
//! timing provenance protocol so both paths use the same published-vector-
//! tested implementation.

/// Return the lowercase hexadecimal SHA-256 digest of `input`.
