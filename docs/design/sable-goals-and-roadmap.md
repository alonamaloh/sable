...
> **Historical research ambitions, not the current implementation plan.** See
> [`../PLAN.md`](../PLAN.md) for provisional priorities and active release
> gates. This companion to the language design remains useful as a record of
> the problems Sable originally set out to explore.
